...
// Regular client for read operations (uses anon key with RLS)
export const supabase = createClient(supabaseUrl, supabaseAnonKey);

// Admin client for write operations (uses service role key, bypasses RLS)
// Only use this for admin operations like creating/updating/deleting personas
